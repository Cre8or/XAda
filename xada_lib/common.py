from xada_lib.interface import *
...
tag_keyword = existing_style("Src-Editor-Keywords-Variant", "keywords", prio=1)
"""
Style for keywords
...
tag_annotation = existing_style("Src-Editor-Code-Annotations-Variant-18", "annotations")
"""
Style for code annotations ("TODO"/"DEBUG")
